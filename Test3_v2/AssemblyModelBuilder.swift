...
protocol AssemblyMainBuilderProtocol {
    ...
    func createMainMainModule(router: RouterProtocol) -> UIViewController
}
...
class AssemblyModelBuilder: AssemblyMainBuilderProtocol {
    ...
    func createMainMainModule(router: RouterProtocol) -> UIViewController {
        ...
        let presenter = CollectionViewPresenter(view: view, networkService: networkService, router: router)
        view.presenter = presenter
        return view
    }
